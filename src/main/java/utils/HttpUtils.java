...
public class HttpUtils {
    ...
    public static InternalLogger logger = InternalLoggerFactory.getInstance(HttpUtils.class);
    ...
    public static <T> T get(Map<String, Object> msgs, String url, Class<T> clazz, int timeOut)
            throws ClientProtocolException, UnknownHostException, IOException {
        String json = HttpUtils.get(msgs, url, timeOut);
        T t = gson.fromJson(json, clazz);
        return t;
    }
